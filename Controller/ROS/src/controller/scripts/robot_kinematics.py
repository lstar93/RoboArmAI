...
def roboarm_inverse_kinematics(join_distances, eff_pos = [1, 1, 1]):
    ...
    thetas = [0, 0, 0, 0]
    disatnces = join_distances

    x0 = float(cos(thetas[0]) * ((disatnces[1] * cos(thetas[1])) + (disatnces[2] * cos(thetas[1] + thetas[2])) + (disatnces[3] * cos(thetas[1] + thetas[2] + thetas[3]))))
    y0 = float(sin(thetas[0]) * ((disatnces[1] * cos(thetas[1])) + (disatnces[2] * cos(thetas[1] + thetas[2])) + (disatnces[3] * cos(thetas[1] + thetas[2] + thetas[3]))))
    z0 = float(disatnces[0]   +  (disatnces[1] * sin(thetas[1])) + (disatnces[2] * sin(thetas[1] + thetas[2])) + (disatnces[3] * sin(thetas[1] + thetas[2] + thetas[3])))